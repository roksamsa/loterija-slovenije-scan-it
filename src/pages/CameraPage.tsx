            ...
            {cands.length > 1 && (
              <ul className="candidates">
                {cands.slice(0, 6).map((c) => (
                  <li key={c.value}>
                    <span>{c.value}</span>
                    <button type="button" onClick={() => setManual(c.value)}>
                      Uporabi
                    </button>
                  </li>
                ))}
  ...
  return (
    <div className="app app--camera">
      ...
      <video
        ...
        className={
          facing === "user" ? "cam-video cam-video--mirror" : "cam-video"
        }
      />
      ...
      <div className="cam-hint" id="main-cam">
        ...
        <p className="cam-hint-text">
          Dotaknite se slike za ostrenje. Držite listek raven in dobro
          osvetljen.
        </p>
      </div>

      <div className="cam-dock" role="toolbar" aria-label="Kamera in nalaganje">
        <button
          type="button"
